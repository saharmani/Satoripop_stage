...
class BuilderTableCreateSatoripopDataWatertemperatures extends Migration
{
    public function up()
    {
        Schema::create('satoripop_data_watertemperatures', function($table)
        {
            $table->engine = 'InnoDB';
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('satoripop_data_watertemperatures');
    }
}
